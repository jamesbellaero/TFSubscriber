...
Header for implementation of the Zig\+Bee Identify Cluster (Z\+CL Spec section 3.\+5).  
...
\begin{DoxyCompactList}\small\item\em Handler for Z\+CL Identify Server Commands (Identify, Identify\+Query). \end{DoxyCompactList}\item 
