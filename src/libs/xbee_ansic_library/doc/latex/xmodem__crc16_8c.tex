...
C\+R\+C16 implementation for use by X\+Bee\textquotesingle{}s Xmodem library if platform doesn\textquotesingle{}t have an existing implementation.  
...
\begin{DoxyCompactList}\small\item\em Table for X\+M\+O\+D\+EM and \char`\"{}\+False C\+C\+I\+T\+T\char`\"{} C\+RC, calculated with standard 0x1021 polynomial. \end{DoxyCompactList}\end{DoxyCompactItemize}
