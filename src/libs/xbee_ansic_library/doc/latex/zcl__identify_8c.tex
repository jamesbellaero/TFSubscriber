...
Server code to implement the Zig\+Bee Identify Cluster (Z\+CL Spec section 3.\+5).  
...
Main program should call \hyperlink{group__zcl__identify_ga95b00d55b861c1ea6033c16794ae818d}{zcl\+\_\+identify\+\_\+isactive()} in its main loop and perform some sort of action (flash an L\+ED or L\+CD backlight) to help an installer identify the device during network commissioning.

Use the macro \hyperlink{group__zcl__identify_gaeae5b3a460629b095247d160235ec586}{Z\+C\+L\+\_\+\+C\+L\+U\+S\+T\+\_\+\+E\+N\+T\+R\+Y\+\_\+\+I\+D\+E\+N\+T\+I\+F\+Y\+\_\+\+S\+E\+R\+V\+ER} to add an Identify Cluster Server to the cluster list of an endpoint.
