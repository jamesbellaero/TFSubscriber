...
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000007}{Todo}]Add code to return an error (and disable the stack) if the X\+Bee responds with an I\+E\+EE address not in Digi\textquotesingle{}s allocation?\end{DoxyRefDesc}
...
\begin{DoxyItemize}
\item Need different levels of V\+E\+R\+B\+O\+SE output.
\begin{DoxyItemize}
\item Errors only
...
\item Add a function to change the timeout for a request (A\+T\+ND, A\+T\+IS?).
