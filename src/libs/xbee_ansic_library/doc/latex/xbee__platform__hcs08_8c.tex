...
Note that on the Programmable X\+Bee, you need to call Init\+R\+T\+C() from main and assign v\+R\+TC to the interrupt in the project\textquotesingle{}s .P\+RM file. 