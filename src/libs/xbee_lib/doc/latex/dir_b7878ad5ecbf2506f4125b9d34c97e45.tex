...
\begin{DoxyCompactList}\small\item\em A\+N\+SI C \hyperlink{group__hal_ga519e5ae2049b59689a474a8c48fee353}{hexstrtobyte()} implementation if not available natively on a given platform. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em C\+R\+C16 implementation for use by X\+Bee\textquotesingle{}s Xmodem library if platform doesn\textquotesingle{}t have an existing implementation. \end{DoxyCompactList}\end{DoxyCompactItemize}
