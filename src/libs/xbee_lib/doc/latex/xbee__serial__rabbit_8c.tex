\hypertarget{xbee__serial__rabbit_8c}{}\section{src/rabbit/xbee\+\_\+serial\+\_\+rabbit.c File Reference}
\label{xbee__serial__rabbit_8c}\index{src/rabbit/xbee\+\_\+serial\+\_\+rabbit.\+c@{src/rabbit/xbee\+\_\+serial\+\_\+rabbit.\+c}}


Serial Interface for X\+Bee Module (Rabbit Platform)  
...
Define X\+B\+E\+E\+\_\+\+O\+N\+\_\+\+S\+E\+RX for every serial port that will/may have an X\+Bee, so we can compile in ser\+Xopen/ser\+Xclose functions for those ports.

\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000003}{Todo}]Need code to make sure IN and O\+UT buffers are large enough for X\+Bee. Does the out buffer need to be large enough to hold an entire frame?\end{DoxyRefDesc}
